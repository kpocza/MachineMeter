...
*/
/*
  Krisztian Pocza (kpocza@kpocza.net)
  Measuring Irms using the two endpoints of the transformator to
...
//--------------------------------------------------------------------------------------
void DiffEnergyMonitor::voltage(unsigned int _inPinV, double _VCAL, double _PHASECAL)
{
  inPinV = _inPinV;
  VCAL = _VCAL;
  PHASECAL = _PHASECAL;
...
void DiffEnergyMonitor::current(unsigned int _inPinI, unsigned int _zePinI, double _ICAL)
{
  inPinI = _inPinI;
  zePinI = _zePinI;
  ICAL = _ICAL;
...
//--------------------------------------------------------------------------------------
void DiffEnergyMonitor::voltageTX(double _VCAL, double _PHASECAL)
{
  inPinV = 2;
  VCAL = _VCAL;
  PHASECAL = _PHASECAL;
...
void DiffEnergyMonitor::currentTX(unsigned int _channel, double _ICAL)
{
...
//--------------------------------------------------------------------------------------
void DiffEnergyMonitor::calcVI(unsigned int crossings, unsigned int timeout)
{
  #if defined emonTxV3
...
void DiffEnergyMonitor::serialprint()
{
...
long DiffEnergyMonitor::readVcc() {
  long result;
